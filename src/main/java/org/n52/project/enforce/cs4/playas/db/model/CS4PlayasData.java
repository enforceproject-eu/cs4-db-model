...
public class CS4PlayasData {
	...
	@Column(name = "monitoring_length_meters")
	private Integer monitoringLengthMeters;

	@Column(name = "initial_coordinates", columnDefinition = "geometry(Point,4326)")
	private Point initialCoordinates;

	@Column(name = "final_coordinates", columnDefinition = "geometry(Point,4326)")
...
//    private Set<CS4PlayasObservedPropertyCount> observedPropertyCounts = new HashSet<CS4PlayasObservedPropertyCount>();

    @ManyToMany
    @JoinTable(
            name = "data_observed_properties",
            joinColumns = @JoinColumn(
                    name = "id"))
    @Column(
	...
	public CS4PlayasData(UUID id) {
		this.id = id;
	}

	public CS4PlayasData(UUID id, String entity, String locationName, String country, String community, String province,
			String municipality, String project, String collectionType, Integer monitoringLenghtMeters,
...
//	}
//
//	public void setObservedPropertyCounts(Set<CS4PlayasObservedPropertyCount> observedPropertyCounts) {
