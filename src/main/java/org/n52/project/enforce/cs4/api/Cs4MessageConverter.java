...
public class Cs4MessageConverter extends AbstractHttpMessageConverter<InputStream> {

    public static final MediaType CS4_PLAYAS_DATA = new MediaType("application", "enforce-cs4-playas-data");
